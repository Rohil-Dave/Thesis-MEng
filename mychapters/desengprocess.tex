...
\begin{table} [htb] % this tells the compiler that a table environment is starting
...
\end{table}
\begin{figure} [htb] % opens the figure environment. the '[H]' forces the image to be Here
...
It is possible to drape the garment on a generic avatar. it does not provide the same visual cues about fit. 

Therefore, it is appropriate to test 
