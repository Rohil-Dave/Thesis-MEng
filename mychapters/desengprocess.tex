...
\begin{table} [H] % this tells the compiler that a table environment is starting
    ...
    \begin{tabular}{p{2cm}|p{6cm}} % this sets up the tabular environment ant states the width of the columns, you could use an equation here using the \textwidth, but i have no experience with this. 
