...
\vspace{\baselineskip}
To address unsustainable practices in the fashion industry, a holistic policy approach is essential. The Circular Policy Canvas, introduced by Puglia et al., systematically maps circular economy (CE) policies across six dimensions to provide a comprehensive overview of the current policy landscape in the European Union. This tool highlights critical gaps and priorities for policy development, illustrating the need for coordinated interventions across the resource life cycle, particularly at the production stage.
\begin{figure} [H]
    \centering
