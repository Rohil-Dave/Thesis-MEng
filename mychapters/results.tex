...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \rotatebox{270}{\includegraphics[width=\textwidth]{Images/real front.png}}
        \caption{Front}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \rotatebox{270}{\includegraphics[width=\textwidth]{Images/real side.png}}
        \caption{Side}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \rotatebox{270}{\includegraphics[width=\textwidth]{Images/real back.png}}
        \caption{Back}
    \end{subfigure}
